...
export interface ActionFlowOptions {
  minRequestMs?: number; // minimum time to show the initial spinner
  minProcessingMs?: number; // minimum time to show the processing/whatsapp phase
  processingLabel?: string; // optional label for the processing phase
}
