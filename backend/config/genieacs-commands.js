...
const parameterPaths = {
    ...
    pppoeIP: [
        'VirtualParameters.pppAddress'                    // ✅ CONFIRMED: 192.168.1.10
    ],
    pppUsername: [
        'VirtualParameters.pppUsername'              // ✅ CONFIRMED: Abdul
    ],
    uptime: [
        'VirtualParameters.uptime'            // ✅ CONFIRMED: 5d 04:50:18
    ],
    firmware: [
    ...
    userConnected: [
        'InternetGatewayDevice.LANDevice.*.Hosts.Host.*.HostName',  // ✅ SSID 1 (2.4GHz) only
        'InternetGatewayDevice.LANDevice.*.Hosts.Host.*.IPAddress',              // ✅ Fallback if needed
        'InternetGatewayDevice.LANDevice.*.Hosts.Host.*.MACAddress'
    ],
    temperature: [
        'VirtualParameters.temp'                    // ✅ CONFIRMED: 48
    ],
    // Additional VirtualParameters yang tersedia
    serialNumber: [
        'InternetGatewayDevice.DeviceInfo.SerialNumber'            // ✅ AVAILABLE: CIOT12E8C8B8
    ],
    ponMode: [
