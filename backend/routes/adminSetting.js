...
const dummySettings = {
    ...
    genieacs_password: process.env.GENIEACS_PASSWORD || 'password',
    ...
    mikrotik_password: process.env.MIKROTIK_PASSWORD || 'password',
    main_interface: process.env.MAIN_INTERFACE || 'ether1',
    company_header: process.env.COMPANY_HEADER || 'ISP Monitor',
    footer_info: process.env.FOOTER_INFO || 'Powered by Gembok',
    server_port: process.env.SERVER_PORT || '3001',
    server_host: process.env.SERVER_HOST || 'localhost',
    customerPortalOtp: process.env.CUSTOMER_PORTAL_OTP || 'false',
    otp_length: process.env.OTP_LENGTH || '6',
    pppoe_monitor_enable: process.env.PPPOE_MONITOR_ENABLE || 'true',
    rx_power_warning: process.env.RX_POWER_WARNING || '-27',
    rx_power_critical: process.env.RX_POWER_CRITICAL || '-30',
    whatsapp_keep_alive: process.env.WHATSAPP_KEEP_ALIVE || 'true'
};
